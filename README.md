...
<div align="center">
  ...
  <img width="55%" src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&duration=3000&pause=800&color=7EE787&background=0D111700&center=false&vCenter=false&multiline=true&repeat=true&width=600&height=250&lines=class+Tharuki%3A;++++def+__init__(self)%3A;++++++++self.role+%3D+%22Developer%22;++++++++self.skills+%3D+%5B%22Python%22%2C+%22JavaScript%22%2C+%22React%22%5D;++++def+build(self)%3A;++++++++return+%22impactful+software%22" alt="Python Animation" />
</div>
